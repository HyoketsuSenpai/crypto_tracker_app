...
// in crypto_tracker_app/test/features/GetCoinList/data/repositories/coin_list_repository_impl_test.dart.
...
class MockCoinListRemoteDataSource extends _i1.Mock
  ...
  @override
  _i3.Future<List<_i4.CoinModel>> getCoinList(int? page) =>
      (super.noSuchMethod(
            Invocation.method(#getCoinList, [page]),
            returnValue: _i3.Future<List<_i4.CoinModel>>.value(
              <_i4.CoinModel>[],
            ),
            returnValueForMissingStub: _i3.Future<List<_i4.CoinModel>>.value(
              <_i4.CoinModel>[],
            ),
          )
